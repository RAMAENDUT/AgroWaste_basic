...
<?php $__env->startSection('title', 'Daftar Modul - AgroWaste Academy'); ?>
...
<div class="px-8 py-8">
    ...
    <h2 class="font-semibold mb-4"><span id="moduleCount"><?php echo e($modules->count()); ?></span> Modul Tersedia</h2>
    ...
    <?php if($modules->count() > 0): ?>
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6" id="modulesGrid">
            <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                ?>
                <div class="module-card bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition" data-level="<?php echo e(strtolower($badge['label'])); ?>" data-title="<?php echo e(strtolower($module->title)); ?>" data-summary="<?php echo e(strtolower($module->description)); ?>">
                    <div class="relative h-40 bg-gradient-to-br from-green-400 to-blue-500 flex items-center justify-center">
                        <span class="text-5xl opacity-20">🌱</span>
                        <span class="absolute top-3 left-3 px-2 py-1 rounded text-[10px] font-medium <?php echo e($badge['color']); ?>"><?php echo e($badge['label']); ?></span>
                    </div>
                    <div class="p-5">
                        <h3 class="font-semibold mb-2 text-sm"><?php echo e($module->title); ?></h3>
                        <p class="text-xs text-gray-600 leading-relaxed mb-4"><?php echo e($module->description); ?></p>
                        <div class="flex items-center gap-3 text-[11px] text-gray-500 mb-4">
                            <span class="flex items-center gap-1">🕐 <?php echo e(($loop->index + 1) * 45); ?> menit</span>
                        ...
                        <a href="<?php echo e(route('modules.show', $module->slug)); ?>" class="block w-full text-center bg-green-600 hover:bg-green-500 text-white py-2 rounded-md text-xs font-medium">Mulai Belajar</a>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\ketapang\Agro Waste\resources\views/modules/index.blade.php ENDPATH**/ ?>