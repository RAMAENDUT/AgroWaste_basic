...
function composeKey(parent2, key, format) {
  if (!parent2) {
    return key;
  }
  return format === "brackets" ? `${parent2}[]` : `${parent2}[${key}]`;
}
...
var CurrentPage = class {
  ...
  swap({
    ...
    if (!viewTransition || !(document == null ? void 0 : document.startViewTransition)) {
      return doSwap();
    }
...
var getScrollableParent = (element) => {
  ...
  let parent2 = element == null ? void 0 : element.parentElement;
  while (parent2) {
...
function convertSequentialObjectsToArrays(value) {
  ...
  for (const key in value) {
    result2[key] = convertSequentialObjectsToArrays(value[key]);
  }
  return result2;
}
...
var headContext = (0, import_react2.createContext)(null);
headContext.displayName = "InertiaHeadContext";
var HeadContext_default = headContext;
var pageContext = (0, import_react3.createContext)(null);
...
function App({
  ...
  if (!current.component) {
    return (0, import_react.createElement)(
      ...
      { value: headManager },
      (0, import_react.createElement)(PageContext_default.Provider, { value: current.page }, null)
    );
  }
  const renderChildren = children || (({ Component, props, key }) => {
    const child = (0, import_react.createElement)(Component, { key, ...props });
    if (typeof Component.layout === "function") {
      return Component.layout(child);
    }
    if (Array.isArray(Component.layout)) {
      return Component.layout.concat(child).reverse().reduce((children2, Layout) => (0, import_react.createElement)(Layout, { children: children2, ...props }));
    }
    return child;
  });
  return (0, import_react.createElement)(
...
function usePage() {
  const page2 = typeof import_react6.default.use === "function" ? import_react6.default.use(PageContext_default) : import_react6.default.useContext(PageContext_default);
  if (!page2) {
...
function useIsomorphicLayoutEffect(effect, deps) {
  typeof window === "undefined" ? (0, import_react9.useEffect)(effect, deps) : (0, import_react9.useLayoutEffect)(effect, deps);
}
...
function useForm(rememberKeyOrInitialValues, maybeInitialValues) {
  ...
  const recentlySuccessfulTimeoutId = (0, import_react8.useRef)(void 0);
  ...
  const [progress22, setProgress] = (0, import_react8.useState)(null);
  ...
  const submit = (0, import_react8.useCallback)(
    (...args) => {
      ...
      const transformedData = transform2.current(data);
      if (method2 === "delete") {
...
var deferStateUpdate = (callback) => {
  typeof import_react7.default.startTransition === "function" ? import_react7.default.startTransition(callback) : setTimeout(callback, 0);
};
var noop2 = () => void 0;
var Form = (0, import_react7.forwardRef)(
  ({
    ...
    const form = useForm({});
    const formElement = (0, import_react7.useRef)(void 0);
    const resolvedMethod = (0, import_react7.useMemo)(() => {
      return isUrlMethodPair(action) ? action.method : method2.toLowerCase();
    }, [action, method2]);
    ...
    const updateDirtyState = (event) => deferStateUpdate(
      () => setIsDirty(event.type === "reset" ? false : !isEqual_default(getData2(), formDataToObject(defaultData.current)))
    );
...
var Head = function({ children, title }) {
  const headManager = (0, import_react11.useContext)(HeadContext_default);
  const provider = (0, import_react11.useMemo)(() => headManager.createProvider(), [headManager]);
  const isServer2 = typeof window === "undefined";
  ...
  function ensureNodeHasInertiaProp(node) {
    return import_react11.default.cloneElement(node, {
  ...
  function renderNodes(nodes) {
    const elements = import_react11.default.Children.toArray(nodes).filter((node) => node).map((node) => renderNode(node));
...
var InfiniteScroll = (0, import_react12.forwardRef)(
  ({
    data,
    buffer = 0,
    as = "div",
    ...
    const [startElementFromRef, setStartElementFromRef] = (0, import_react12.useState)(null);
    const startElementRef = (0, import_react12.useCallback)((node) => setStartElementFromRef(node), []);
    const [endElementFromRef, setEndElementFromRef] = (0, import_react12.useState)(null);
    const endElementRef = (0, import_react12.useCallback)((node) => setEndElementFromRef(node), []);
    const [itemsElementFromRef, setItemsElementFromRef] = (0, import_react12.useState)(null);
    const itemsElementRef = (0, import_react12.useCallback)((node) => setItemsElementFromRef(node), []);
    const [loadingPrevious, setLoadingPrevious] = (0, import_react12.useState)(false);
    const [loadingNext, setLoadingNext] = (0, import_react12.useState)(false);
    const [requestCount, setRequestCount] = (0, import_react12.useState)(0);
    const [resolvedStartElement, setResolvedStartElement] = (0, import_react12.useState)(null);
    const [resolvedEndElement, setResolvedEndElement] = (0, import_react12.useState)(null);
    const [resolvedItemsElement, setResolvedItemsElement] = (0, import_react12.useState)(null);
    ...
    const scrollableParent = (0, import_react12.useMemo)(() => getScrollableParent(resolvedItemsElement), [resolvedItemsElement]);
    const callbackPropsRef = (0, import_react12.useRef)({
      buffer,
      onlyNext,
      onlyPrevious,
      reverse: reverse2,
    ...
    const [infiniteScroll, setInfiniteScroll] = (0, import_react12.useState)(null);
    const dataManager = (0, import_react12.useMemo)(() => infiniteScroll == null ? void 0 : infiniteScroll.dataManager, [infiniteScroll]);
    const elementManager = (0, import_react12.useMemo)(() => infiniteScroll == null ? void 0 : infiniteScroll.elementManager, [infiniteScroll]);
    ...
    const manualMode = (0, import_react12.useMemo)(
      () => manual || manualAfter > 0 && requestCount >= manualAfter,
      [manual, manualAfter, requestCount]
    );
    const autoLoad = (0, import_react12.useMemo)(() => !manualMode, [manualMode]);
    (0, import_react12.useEffect)(() => {
    ...
    (0, import_react12.useEffect)(() => {
      const shouldAutoScroll = autoScroll !== void 0 ? autoScroll : reverse2;
      if (shouldAutoScroll) {
        scrollToBottom();
      }
    }, [scrollableParent]);
    ...
    const exposedPrevious = {
      ...
      hasMore: (dataManager == null ? void 0 : dataManager.hasPrevious()) ?? false,
      ...sharedExposed
    };
    const exposedNext = {
      loading: loadingNext,
      ...
      hasMore: (dataManager == null ? void 0 : dataManager.hasNext()) ?? false,
      ...sharedExposed
    };
    const exposedSlot = {
    ...
    return (0, import_react12.createElement)(import_react12.default.Fragment, {}, ...reverse2 ? [...renderElements].reverse() : renderElements);
  }
);
...
var Link = (0, import_react13.forwardRef)(
  ({
    ...
    const [inFlightCount, setInFlightCount] = (0, import_react13.useState)(0);
    const hoverTimeout = (0, import_react13.useRef)(void 0);
    const _method = (0, import_react13.useMemo)(() => {
      return isUrlMethodPair(href) ? href.method : method2.toLowerCase();
    }, [href, method2]);
    const _as = (0, import_react13.useMemo)(() => {
      if (typeof as !== "string" || as.toLowerCase() !== "a") {
        return as;
      }
      return _method !== "get" ? "button" : as.toLowerCase();
    }, [as, _method]);
    const mergeDataArray = (0, import_react13.useMemo)(
      () => mergeDataIntoQueryString(_method, isUrlMethodPair(href) ? href.url : href, data, queryStringArrayFormat),
      [href, _method, data, queryStringArrayFormat]
    );
    const url = (0, import_react13.useMemo)(() => mergeDataArray[0], [mergeDataArray]);
    const _data = (0, import_react13.useMemo)(() => mergeDataArray[1], [mergeDataArray]);
    const baseParams = (0, import_react13.useMemo)(
      () => ({
        data: _data,
        method: _method,
        preserveScroll,
      ...
      [_data, _method, preserveScroll, preserveState, preserveUrl, replace2, only, except, headers, async]
    );
    const visitParams = (0, import_react13.useMemo)(
      () => ({
        ...baseParams,
        viewTransition,
        onCancelToken,
    ...
    const prefetchModes = (0, import_react13.useMemo)(
      () => {
        if (prefetch === true) {
          return ["hover"];
        }
    ...
    const cacheForValue = (0, import_react13.useMemo)(() => {
      if (cacheFor !== 0) {
        return cacheFor;
      }
    ...
    const doPrefetch = (0, import_react13.useMemo)(() => {
      return () => {
        router.prefetch(
          url,
          {
    ...
    const elProps = (0, import_react13.useMemo)(() => {
      if (_as === "button") {
        return { type: "button" };
      }
...
function usePoll(interval, requestOptions = {}, options = {
  ...
  const pollRef = (0, import_react14.useRef)(
...
function usePrefetch(options = {}) {
  ...
  const [lastUpdatedAt, setLastUpdatedAt] = (0, import_react15.useState)((cached == null ? void 0 : cached.staleTimestamp) || null);
  const [isPrefetching, setIsPrefetching] = (0, import_react15.useState)(inFlight !== null);
  const [isPrefetched, setIsPrefetched] = (0, import_react15.useState)(cached !== null);
...
var WhenVisible = ({ children, data, params, buffer, as, always, fallback }) => {
  ...
  const fetching = (0, import_react16.useRef)(false);
  const ref = (0, import_react16.useRef)(null);
  const observer = (0, import_react16.useRef)(null);
  const page2 = usePage();
  (0, import_react16.useEffect)(() => {
    if (Array.isArray(data)) {
      if (data.some((key) => page2.props[key] === void 0)) {
        setLoaded(false);
      }
    } else if (data) {
      if (page2.props[data] === void 0) {
        setLoaded(false);
      }
    }
  }, [data, ...Array.isArray(data) ? data.map((key) => page2.props[key]) : [page2.props[data]]]);
  const getReloadParams = (0, import_react16.useCallback)(() => {
    if (data) {
      return {
      ...
      (entries) => {
        ...
        router.reload({
          ...
          onFinish: (e) => {
            ...
            if (!always) {
              (_b = observer.current) == null ? void 0 : _b.disconnect();
            }
          }
        });
      },
